...
nail_holo_linear = ('Blue Freezie', 'Purple Slushie', 'Magenta Jelly', 'Red Licorice', 'Orange Drink', 'Lemon Sucker', 'Green Taffy')

nail_holo_glitter = ('Zyler the Cat', 'Menchie the Cat', 'Everything is Pine', 'Choco Holo', 'Naughty List', 'Gold Play Button', 'Black Holo Wish', 'Plumb Luck', 'Party Punch', 'Midnight Spark', 'Rainbow Snow', 'Play Rose', 'Frost Light')

nail_multichrome = ('Chameleon Coat', "Blue Ain't Slick", 'Missed-Shift', 'Purple with Envy', "Cats' Evation")

nail_shimmer = ('Got Cake')
